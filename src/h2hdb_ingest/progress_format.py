...
_OPERATION_LABELS = {
    ...
    "waiting_for_disk_capacity": "Waiting for free disk space before retrying publication",
    ...
    "archive_finalize": "Flushing the verified CBZ in private staging storage",

...
def _repository(tmp_path: Path) -> tuple[Path, str, str]:
    ...
    _write_version(repository, "0.9.0")
    ...
    _write_version(repository, "0.9.1")
    version_commit = _commit(repository, "chore(release): bump version to 0.9.1")
